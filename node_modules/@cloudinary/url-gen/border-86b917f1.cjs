...
var RoundCornersAction = require('./RoundCornersAction-305e4ce4.cjs');
...
class BorderAction extends Action.Action {
    ...
    constructor(borderType, color, borderWidth) {
        ...
        this._actionModel = {
            borderType,
            borderColor: prepareColor.prepareColor(color),
            borderWidth,
            actionType: 'border',
        };
    }
    ...
    color(borderColor) {
        ...
        this._actionModel.borderColor = prepareColor.prepareColor(borderColor);
        return this;
    }
    /**
    ...
    solid(width, color) {
        ...
        this._actionModel.borderColor = prepareColor.prepareColor(color);
        ...
        if (roundCorners) {
            const roundCornersAction = (() => {
                ...
                if (Array.isArray(roundCorners.radius)) {
                    return new RoundCornersAction.RoundCornersAction().radius(...roundCorners.radius);
                }
                return undefined;
            })();
